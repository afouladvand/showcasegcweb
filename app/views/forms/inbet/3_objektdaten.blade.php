    ...
    <h3> {{{Lang::get('forms/inbet.step3_title')}}}</h3>

    <div class="form-group">
        <fieldset>
            <div class="row toppaddingbox">
                {{ Form::label('bedarfsart',  Lang::get('forms/inbet.step3_custType'),['class' =>'col-md-4 control-label']) }}
                {{ Form::toggleSwitch('bedarfsart', array(  Lang::get('forms/inbet.step3_home'),  Lang::get('forms/inbet.step3_commerce')),array('1', '2'),
                array('class'=>'btn-group btn-toggle col-md-4 postinput')) }}
            </div>
            <h4>{{{ Lang::get('forms/inbet.step3_section1_title')}}}</h4>
            <br>
            ...
            <div class="row toppaddingbox">
                {{ Form::label('ObjAdrFlurWe',  Lang::get('forms/inbet.step3_flur_we'),['class' =>'col-md-4 control-label']) }}
                <div class="col-md-8 row " id="ObjAdrFlurWe" name="ObjAdrFlurWe">
                    <div class="col-md-4 ">
                    {{ Form::text('ObjAdrFlur', null,['placeholder' =>  Lang::get('forms/inbet.step3_flurStk'),'class' => 'form-control postinput
                        input-md']) }}
                    </div>
                    <div class="col-md-4 ">
                    {{ Form::text('ObjAdrWe', null,['placeholder' =>  Lang::get('forms/inbet.step3_we'),'class' => 'form-control postinput
                        input-md']) }}
                    </div>
                </div>
            </div>
